...
-- grandmas generate 1 cookie every second
local grandmas = 0
...
function hoveringOverCursor()
    ...
    return x <= 64 + cursorTexture:getWidth() and x >= 64 and
           y <= WINDOW_HEIGHT - 120 + cursorTexture:getHeight() and y >= WINDOW_HEIGHT - 120 
end
...
function hoveringOverGrandma()
    ...
    return x <= 148 + grandmaTexture:getWidth() and x >= 148 and
           y <= WINDOW_HEIGHT - 132 + grandmaTexture:getHeight() and y >= WINDOW_HEIGHT - 132 
end
